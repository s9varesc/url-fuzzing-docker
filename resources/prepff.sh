...
export PATH
PATH=$PATH:/root/.cargo/bin /root/.cargo/bin/rustup toolchain install nightly-2020-08-27
PATH=$PATH:/root/.cargo/bin /root/.cargo/bin/rustup default nightly-2020-08-27
